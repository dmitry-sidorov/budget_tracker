defmodule BudgetTrackerWeb.Components.MegaMenu do
  @moduledoc """
  The `BudgetTrackerWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
