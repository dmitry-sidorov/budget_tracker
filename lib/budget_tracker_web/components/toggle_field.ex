defmodule BudgetTrackerWeb.Components.ToggleField do
  @moduledoc """
  BudgetTrackerWeb.Components.ToggleField component renders a toggle field with customizable options.
