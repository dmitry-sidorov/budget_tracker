defmodule BudgetTrackerWeb.Components.Skeleton do
  @moduledoc """
  The `BudgetTrackerWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
