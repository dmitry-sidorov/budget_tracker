defmodule BudgetTrackerWeb.Components.Rating do
  @moduledoc """
  The `BudgetTrackerWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
