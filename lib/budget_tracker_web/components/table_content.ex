defmodule BudgetTrackerWeb.Components.TableContent do
  @moduledoc """
  `BudgetTrackerWeb.Components.TableContent` is a component module designed to create flexible and dynamic
