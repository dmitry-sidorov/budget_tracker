defmodule BudgetTrackerWeb.Components.Gallery do
  @moduledoc """
  The `BudgetTrackerWeb.Components.Gallery` module provides a customizable gallery component for displaying
