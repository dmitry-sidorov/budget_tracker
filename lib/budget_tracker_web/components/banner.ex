defmodule BudgetTrackerWeb.Components.Banner do
  @moduledoc """
  BudgetTrackerWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
