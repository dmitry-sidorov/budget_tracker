defmodule BudgetTrackerWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `BudgetTrackerWeb.Components.Carousel`
  project.
