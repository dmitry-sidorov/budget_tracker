defmodule BudgetTrackerWeb.Components.UrlField do
  @moduledoc """
  BudgetTrackerWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
