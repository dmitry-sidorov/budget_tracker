defmodule BudgetTrackerWeb.Components.SpeedDial do
  @moduledoc """
  The `BudgetTrackerWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
