defmodule BudgetTrackerWeb.Components.Menu do
  @moduledoc """
  The `BudgetTrackerWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  import BudgetTrackerWeb.Components.Accordion, only: [accordion: 1]
  import BudgetTrackerWeb.Components.Button, only: [button_link: 1]
