defmodule BudgetTrackerWeb.Components.Alert do
  @moduledoc """
  BudgetTrackerWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
