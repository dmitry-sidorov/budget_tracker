defmodule BudgetTrackerWeb.Components.Chat do
  @moduledoc """
  `BudgetTrackerWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
