defmodule BudgetTrackerWeb.Components.Popover do
  @moduledoc """
  The `BudgetTrackerWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
