defmodule BudgetTrackerWeb.Components.InputField do
  @moduledoc """
  The `BudgetTrackerWeb.Components.InputField` module provides a customizable input field component that
