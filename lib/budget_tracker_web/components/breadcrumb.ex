defmodule BudgetTrackerWeb.Components.Breadcrumb do
  @moduledoc """
  Provides a flexible and customizable `BudgetTrackerWeb.Components.Breadcrumb` component for displaying
