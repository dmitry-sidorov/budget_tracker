defmodule BudgetTrackerWeb.Components.Spinner do
  @moduledoc """
  The `BudgetTrackerWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `BudgetTrackerWeb.Components.Spinner` module enables developers to provide
