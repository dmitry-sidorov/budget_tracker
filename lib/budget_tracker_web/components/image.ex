defmodule BudgetTrackerWeb.Components.Image do
  @moduledoc """
  The `BudgetTrackerWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
