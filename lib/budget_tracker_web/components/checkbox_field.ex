defmodule BudgetTrackerWeb.Components.CheckboxField do
  @moduledoc """
  BudgetTrackerWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
